...
* Machine learning can improve public policy by making state interventions more effective
...
* Easy to install, quick to deploy, some need just two lines of code to
  estimate thousands of models

* Widely used in computer science, little known in political science and
  economics

* Perfectly usable to public policy problems
...
* Show how to install and use them with tabular data
...
* Show how to use [Docker](docker.com) to create a fully reproducible machine
  learning pipeline 
...
* Encourage scholars unfamiliar with machine learning to use predictive models

* Provide experienced users with useful benchmarks

* Show that AutoML can be easily taught at computational social science
  courses, graduate and undergraduate levels

* Motivate scholars to move beyond current reproducibility practices and adopt
  a more comprehensive approach to replication
...
* One of the easiest AutoML algorithms to use
