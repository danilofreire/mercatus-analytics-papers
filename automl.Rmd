...
`AutoGluon`. Another limitation of `Auto-sklearn` is that it only works on
Linux and Windows. As of December 2020, there is no support for OSX. Mac users,
however, can use a Docker image to load the library.
...
forecasting power of the model and find an area under the ROC curve of 0.738. I
then assess how 
