...
function, including the metric they want to minimise of maximise, such as
accuracy or area under the ROC curve, and set the number of networks the model
will create and the time reserved for each task. Please refer to 
...
algorithms had a limited modelling time (10 minutes), the results are an
indicative of their strong forecasting accuracy even in adverse conditions.
